...
# rpm packages
GLIBCDEVDIR=$RPMDIR/glibc-devel-2.4-25.i586.rpm
GCCDIR=$RPMDIR/gcc-4.1.0-25.i586.rpm
LIBSTDDIR=$RPMDIR/libstdc++-4.1.0-25.i586.rpm
LIBSTDDEVDIR=$RPMDIR/libstdc++-devel-4.1.0-25.i586.rpm
GPPDIR=$RPMDIR/gcc-c++-4.1.0-25.i586.rpm
KERNELDIR=$RPMDIR/kernel-source-2.6.16.13-4.i586.rpm
ZLIBDEVDIR=$RPMDIR/zlib-devel-1.2.3-13.i586.rpm
READLINEDEVDIR=$RPMDIR/readline-devel-5.1-22.i586.rpm
WGETDIR=$RPMDIR/wget-1.10.2-13.i586.rpm
ZIPDIR=$RPMDIR/zip-2.31-13.i586.rpm
UNZIPDIR=$RPMDIR/unzip-5.52-14.i586.rpm
